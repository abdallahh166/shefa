...
const PaginationPrevious = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => {
  ...
  return (
    <PaginationLink aria-label={t("common.previousPage")} size="default" className={cn("gap-1 ps-2.5", className)} {...props}>
...
const PaginationNext = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => {
  ...
  return (
    <PaginationLink aria-label={t("common.nextPage")} size="default" className={cn("gap-1 pe-2.5", className)} {...props}>
