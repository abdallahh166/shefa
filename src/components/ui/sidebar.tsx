...
import { Button as DsButton } from "@/components/primitives/Button";
...
const SidebarTrigger = React.forwardRef<React.ElementRef<typeof UiButton>, React.ComponentProps<typeof UiButton>>(
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <DsButton
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 p-0 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] group-data-[side=left]:-right-4 group-data-[side=right]:left-0 hover:after:bg-sidebar-border sm:flex",
